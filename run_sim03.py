...
# %% Run neurotron for simulation 3
...
# %% Save output of simulation 3

np.savetxt(output_path.joinpath(sim03_setup['name']+'_tron.csv'), np.squeeze(tron_error), delimiter=',')
np.savetxt(output_path.joinpath(sim03_setup['name']+'_sgd.csv'), np.squeeze(sgd_error), delimiter=',')
