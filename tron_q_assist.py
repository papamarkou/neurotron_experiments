...
for i in range(2):
    plt.plot(x,y[i],'o',label= ("degree=",i+2))
    #plt.plot(x,y[i],'b')
    plt.yscale('log')
    #plt.ylabel("log (parabola)")
    plt.xlabel('x')
    plt.legend()
...
"""#Checking SGD + Stochastic NeuroTron """
            ...
            for beta in betalist: 
                for eta in etalist:  
                    for b  in blist:    
                        ...
                        print()
                        # plt.plot(err_final/samples,'.',label=  ("theta_* =",bound))
                        # plt.yscale('log')
                        # plt.ylabel('sample averaged parameter error in log scale')
                        # plt.xlabel('iteration')
                        # plt.legend()

                        #axs[0].plot(err_final_sgd/samples,'.',label=  ("beta =",beta,"theta_* =",bound))
                        #axs[0].set_xlabel('iterations of S.G.D.')
                        #axs[0].set_ylabel('sample averaged parameter error in log scale')
                        #axs[0].set_yscale('log')

                        axs[1].plot(err_final_neuro10/samples,'.',label=  ("beta =",beta,"theta_* =",bound))
                        axs[1].set_xlabel('iterations of Stochastic NeuroTron (q=10)')
                        axs[1].set_ylabel('sample averaged parameter error in log scale')
                        axs[1].set_yscale('log')

                        axs[0].plot(err_final_neuro1/samples,'.',label=  ("beta =",beta,"theta_* =",bound))
                        axs[0].set_xlabel('iterations of Stochastic NeuroTron (q=1)')
                        axs[0].set_ylabel('sample averaged parameter error in log scale')
                        axs[0].set_yscale('log')
