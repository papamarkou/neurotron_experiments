...
# %% Run neurotron for simulation 4
...
# %% Save output of simulation 4

np.savetxt(output_path.joinpath(sim04_setup['name']+'_tron.csv'), np.squeeze(tron_error), delimiter=',')
np.savetxt(output_path.joinpath(sim04_setup['name']+'_sgd.csv'), np.squeeze(sgd_error), delimiter=',')
