...
# %% Generate and save figure for simulation 2
...
plt.savefig(
    output_path.joinpath(sim02_setup['name']+'.png'),
    dpi=300,
...
# %% Generate and save zoomed in figure for simulation 2
...
plt.savefig(
    output_path.joinpath(sim02_setup['name']+'_zoomed.png'),
    dpi=300,
    pil_kwargs={'quality': 100},
    transparent=True,
    bbox_inches='tight',
